...
// let data = {"test3":{"1":"#9a4343","3":"#a98181","5":"#b52b2b","7":"#907c7c"},"test1":{"test2":{"test5":{"2":"#774c4c","4":"#cc9999"}},"test4":{"6":"#385f82","8":"#9a5a5a"}}};

// let colors = [];
// let borders =[];
// let boxes =document.getElementById('js');


// overrideObject(data, buildHtml);

// function overrideObject(obj, callback) {
...
//             colors.push(value);
//         } else {
//             overrideObject(value);
//         }    
//     };
//     callback(colors, borders);
//     console.log(colors, borders);
// };

// function buildHtml(c, b) {
//     if(c.length == b.length){
//         for(let i = 0, len = c.length, boxe; i < len; i++){
//             boxe = document.createElement('div');
//             boxe.classList.add('box');
//             boxe.style.background = c[i];
//             boxe.style.borderWidth = b[i]+'px';
//             boxes.appendChild(boxe);
//         };
//     }
//     console.log(c,b);
// }
